...
import com.nit.BootIocProj03DiMiniProjectApp;
import com.nit.model.Employee;

@Repository("empMySqlDAO")
public class MySqlEmployeeDAOImpl implements IEmployeeDAO {

    private final BootIocProj03DiMiniProjectApp bootIocProj03DiMiniProjectApp;

	private static final String GET_EMPS_BY_DESG="Select ENO,ENAME,DESG,SALARY,DEPTNO from Employee where DESG IN(?,?,?) order by DESG";
	private static final String INSERT_EMP_QUERY="INSERT INTO EMPLOYEE(ENAME,DESG,SALARY,DEPTNO) VALUES(?,?,?,?)";   // we have taken support of sequences to insert the value
	
	@Autowired
	private DataSource ds;


    MySqlEmployeeDAOImpl(BootIocProj03DiMiniProjectApp bootIocProj03DiMiniProjectApp) {
        this.bootIocProj03DiMiniProjectApp = bootIocProj03DiMiniProjectApp;
    }
	...
	public List<Employee> getEmployeesByDesgs(String desg1, String desg2, String desg3) throws SQLException {
		System.out.println("MySqlEmployeeDAOImpl.getEmployeesByDesgs()");
